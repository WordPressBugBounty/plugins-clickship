...
if ( ! class_exists( 'WC_Clickship_Shipping_Rates_Method' ) ) {
	class WC_Clickship_Shipping_Rates_Method extends WC_Shipping_Method {
	 ...
	 /**
     * The ClickShip API URL.
     *
     * This property stores the URL for the ClickShip service, which is used 
     * to fetch shipping rates and process shipping requests.
     *
     * @since    1.0.0
     * @access   protected
     * @var      string    $clickship_url    The ClickShip API URL.
     */
    protected string $clickship_url;

    /**
     * The marketplace ID associated with ClickShip.
     *
     * This property holds the marketplace ID that is retrieved from the 
     * plugin settings. It helps identify the specific marketplace that 
     * is linked to the shipping process.
     *
     * @since    1.0.0
     * @access   protected
     * @var      string    $marketplace_id    The marketplace ID for ClickShip.
     */
    protected string $marketplace_id;

    /**
     * The ClickShip enable status.
     *
     * This property determines whether ClickShip Real-time rates is enabled 
     * or disabled, based on the plugin's configuration settings.
     *
     * @since    1.0.0
     * @access   protected
     * @var      string    $clickship_enable    The ClickShip enable status.
     */
    protected string $clickship_enable;
